...
public class ListReclamationForm extends BaseForm{
    ...
    cnt.addAll(btnAddRecs); super.add(cnt);
        ...
        Button pdf = new Button("FORMAT PDF");
        addStringValue("", pdf);

        pdf.addPointerPressedListener(l -> {
            String urlab = "http://localhost/pdf/ex.php";
            for (Reclamation r : new ServiceReclamation().affichageReclamation(42)) {
            ...
            cnreq.addResponseListener(evx
                ...
                Dialog dig = new Dialog("FORMAT PDF");
